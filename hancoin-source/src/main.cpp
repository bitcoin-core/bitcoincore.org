...
uint256 hashGenesisBlock("0xe4eb9d74176a81e4347edf58ecea38e9f776e00e2c1e7e197667c132e68583e0");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1523333436, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "The Suburbs of Los Angeles where Developer Han brinks on bail out";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1000 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04fa2c7ac7191d6800cdac6d9e9247e07e115bb73b0f6c613afe1f45a75b2133bfc2732c20822745d815fb8824ad577e3a2c0e682f79a1612ef31bb49e53093b91") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1523333436;
        ...
        assert(block.hashMerkleRoot == uint256("0x2df239507e95f1db6ce73628f11959e32b458f6a58190ef4f42f53f63da1fb51"));
...
unsigned char pchMessageStart[4] = { 0x49, 0x99, 0xe2, 0x5a }; // HanCoin: increase each by adding 2 to bitcoin's value.
