...
ECDSA signatures inside Bitcoin transactions now use validation using [libsecp256k1](https://github.com/bitcoin/secp256k1) instead of OpenSSL.
...
A more detailed documentation about keeping traffic low can be found in [/doc/reduce-traffic.md](https://github.com/bitcoin/bitcoin/blob/v0.12.0/doc/reduce-traffic.md).
...
Please see [docs/zmq.md](https://github.com/bitcoin/bitcoin/blob/v0.12.0/doc/zmq.md) for details of operation.
