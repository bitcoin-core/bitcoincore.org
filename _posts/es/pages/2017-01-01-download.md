...
verifying_and_reproducing: >
  Las instrucciones de verificación precedentes verificarán que varios
  contribuyentes en quienes confías han firmado todos las mismas
  checksums distribuídas en el fichero de checksums de la versión.
  Alternativamente, reproducir la construcción de un programa binario
  por ti mismo te proveerá con el mayor de los niveles de garantía
  actualmente disponibles.  Para más información, visita el
  repositorio de
