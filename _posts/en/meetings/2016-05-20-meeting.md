...
- Link to [meeting notes (text)](/logs/2016-05-zurich-meeting-notes.txt).
- Link to [meeting notes (html)](/logs/2016-05-zurich-meeting-notes.html).
...
The pull request has been completed and is read for review.
