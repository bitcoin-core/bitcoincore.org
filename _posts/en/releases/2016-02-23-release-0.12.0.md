...
A more detailed documentation about keeping traffic low can be found in [/doc/reduce-traffic.md](https://github.com/bitcoin/bitcoin/blob/0.12/doc/reduce-traffic.md).
...
Please see [docs/zmq.md](https://github.com/bitcoin/bitcoin/blob/0.12/doc/zmq.md) for details of operation.
