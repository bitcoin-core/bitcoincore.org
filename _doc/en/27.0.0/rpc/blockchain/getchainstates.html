...
btcversion: 27.0.0
btcgroup: blockchain
permalink: en/doc/27.0.0/rpc/blockchain/getchainstates/
---
...
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id": "curltest", "method": "getchainstates", "params": []}' -H 'content-type: text/plain;' http://127.0.0.1:8332/
