...
btcversion: 25.0.0
btcgroup: wallet
permalink: en/doc/25.0.0/rpc/wallet/createwallet/
---
...
{                       (json object)
  ...
  "warning" : "str",    (string, optional) Warning messages, if any, related to creating the wallet. Multiple messages will be delimited by newlines. (DEPRECATED, returned only if config option -deprecatedrpc=walletwarningfield is passed.)
  "warnings" : [        (json array, optional) Warning messages, if any, related to creating the wallet.
    "str",              (string)
    ...
  ]
}
